...
import com.example.demo.common.entity.SortE;
...
public class SortListUtil {  
    ...
    public static void main(String[] args) throws Exception {  
        ...
        list.add(new Student(3, "b", 1,true, new Date(11110000),new SortE(2)));
        list.add(new Student(1, "c", 3, false,new Date(44440000),new SortE(3)));
        list.add(new Student(2, "a", 2, false,new Date(22210000),new SortE(1)));
        list.add(new Student(4, "a", 11, true,new Date(33330000),new SortE(4)));
        ...
        System.out.println("---------测试多个排序字段,先按name正序,name相同时再按id正序-----------------");  
        for (Student stu : list) {  
            System.out.println(stu.toString());  
        }  
        ...
        System.out.println("---------测试实现了Comparable接口的对象排序,按birthday正序-----------------");  
        for (Student stu : list) {  
            System.out.println(stu.toString());  
        }  
